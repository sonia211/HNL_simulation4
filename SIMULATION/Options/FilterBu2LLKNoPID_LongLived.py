...
SelDSTWriterConf = {
    'default'              : stripMicroDSTStreamConf(pack=True,selectiveRawEvent=True)
    }
...
stck = StrippingTCK(HDRLocation = '/Event/Strip/Phys/DecReports', TCK=0x41402800) 
