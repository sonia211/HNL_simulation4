...
int main() {
	...
	//vector<Double_t> mNvec = {2.0,2.5};
	//vector<Double_t> tau0vec = {10., 20., 50.};
	...
	cout << "____" << mNvec.size() << " " << mNvec[0]  << " "<< mNvec.back() << " " <<  tau0vec.size() << " " << tau0vec[0] << " " << tau0vec.back() << endl;
	
	TTree *T = new TTree("TsqsScan","mytree");
	//TH2D *hscan_nNP = new TH2D("hscan_nNP", "hscan_nNP", mNvec.size(), mNvec[0], mNvec.back(), tau0powervec.size(), tau0powervec[0], tau0powervec.back());
	//TH2D *hscan_nND = new TH2D("hscan_nND", "hscan_nND", mNvec.size(), mNvec[0], mNvec.back(), tau0powervec.size(), tau0powervec[0], tau0powervec.back());
	...
	//TH2D *hscan_rN = new TH2D("hscan_rN", "hscan_rN",    mNvec.size(), mNvec[0], mNvec.back(), tau0vec.size(), tau0vec[0], tau0vec.back());
